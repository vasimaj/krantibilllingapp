...
import { saveTaxMasterApi } from "../../Services/MasterServices/TaxMasterAPIURL";
...
const TaxMaster = () => {
    ...
    //form field for tax master start;
    ...
    const insertFun = async () => {
        ...
        await axios.post(saveTaxMasterApi, saveObj)
            .then((res) => {
                if (res.data === "SAVED") {
                    getTypeMasterData();
                    clearFun();
                    toast.success("Tax Master saved sucessfully");
                }
                else {
                    toast.error("Operation Failed.");
                }
                ...
                <Col xl={10}>
                    <Form onSubmit={saveFun}>
                        ...
                        <Form.Label>Tax Name :</Form.Label>
                            <Form.Control type="text" placeholder="Enter Tax Name..." required
                                value={Tax_Name}
                        ...
                        <Form.Label>GST :</Form.Label>
                            <Form.Control type="text" placeholder="Enter GST" required
                                value={Cgst}
                        ...
                        <Form.Label>CGST :</Form.Label>
                            <Form.Control type="text" placeholder="Enter CGST" required
                                value={Cgst}
                                onChange={(e) => setCgst(e.target.value)}
                            />
                        </div>
                        ...
                        <Form.Label>SGST :</Form.Label>
                            <Form.Control type="text" placeholder="Enter SGST" required
                                value={Sgst}
                        ...
                        <Form.Label>IGST :</Form.Label>
                            <Form.Control type="text" placeholder="Enter IGST" required
                                value={Igst}
                        ...
                        <Form.Label>CESS :</Form.Label>
                            <Form.Control type="text" placeholder="Enter Cess Number" required
                                value={Cess}
